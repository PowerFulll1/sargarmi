...
class Bot(BaseBot):
    ...
    jok_responses = [
        ...
        " 😂یارو توی چت از طرف پرسید چند سالته؟ گفت پونزده . گفتش عه بچه سالی حالا اندازه من که شدی پخته تر میشی . گفتش مگه چند سالته؟ گفت: من شونزده ",
        ]
    ...
    async def on_user_join(self, user: User) -> None:
        ...
        await self.highrise.chat(f" سلام،  {self.room_name} {user.username} بنویس : جوک . فال . سنگ . تاس")
...
if __name__ == "__main__":
    room_id = "654b35d6162b6aee01154b0b"
    token  = "8a7433baa15532d162bb52f1d00b14309024b358e97ef5131f6aff3b38c7d09b"
